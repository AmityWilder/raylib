...
// THIS FILE HAS BEEN ALTERED FROM ITS ORIGINAL SOURCE
#define HENRY_EXTRAS
...
#ifndef TO_BYTE_CLAMPED
#define TO_BYTE_CLAMPED(f) (Byte)(fminf(fmaxf((f),0.0f),1.0f)*255.0f)
#endif
#ifndef TO_BYTE_UNCLAMPED
// Likely to be wrapped
#define TO_BYTE_UNCLAMPED(f) (Byte)(f*255.0f)
#endif
...
struct Vector3
{
    ...
    static constexpr Vector3 One()      { return Vector3( 1, 1 ); }
    static constexpr Vector3 Left()     { return Vector3(-1, 0 ); }
    static constexpr Vector3 Right()    { return Vector3(+1, 0 ); }
    static constexpr Vector3 Up()       { return Vector3( 0,+1 ); }
    static constexpr Vector3 Down()     { return Vector3( 0,-1 ); }
    static constexpr Vector3 Forward()  { return Vector3( 0,+1 ); }
    static constexpr Vector3 Backward() { return Vector3( 0,-1 ); }
};
...
struct Color
{
    ...
    constexpr Color(Byte gray)
        : r(gray), g(gray), b(gray), a(255u) {}

    // Transparent grayscale
    constexpr Color(Byte gray, Byte alpha)
    ...
    // Transparent color
    constexpr Color(Byte red, Byte green, Byte blue, Byte alpha)
        : r(red), g(green), b(blue), a(alpha) {}

    Byte r;        // Color red value
    Byte g;        // Color green value
    Byte b;        // Color blue value
    Byte a;        // Color alpha value

    // Some Basic Colors
    // NOTE: Custom raylib color palette for amazing visuals on WHITE background
    static constexpr Color Yellow()     { return { 253u, 249u,   0u }; } // Yellow
    static constexpr Color Gold()       { return { 255u, 203u,   0u }; } // Gold
    static constexpr Color Orange()     { return { 255u, 161u,   0u }; } // Orange
    static constexpr Color Pink()       { return { 255u, 109u, 194u }; } // Pink
    static constexpr Color Red()        { return { 230u,  41u,  55u }; } // Red
    static constexpr Color Maroon()     { return { 190u,  33u,  55u }; } // Maroon
    static constexpr Color Green()      { return {   0u, 228u,  48u }; } // Green
    static constexpr Color Lime()       { return {   0u, 158u,  47u }; } // Lime
    static constexpr Color DarkGreen()  { return {   0u, 117u,  44u }; } // Dark Green
    static constexpr Color SkyBlue()    { return { 102u, 191u, 255u }; } // Sky Blue
    static constexpr Color Blue()       { return {   0u, 121u, 241u }; } // Blue
    static constexpr Color DarkBlue()   { return {   0u,  82u, 172u }; } // Dark Blue
    static constexpr Color Purple()     { return { 200u, 122u, 255u }; } // Purple
    static constexpr Color Violet()     { return { 135u,  60u, 190u }; } // Violet
    static constexpr Color DarkPurple() { return { 112u,  31u, 126u }; } // Dark Purple
    static constexpr Color Beige()      { return { 211u, 176u, 131u }; } // Beige
    static constexpr Color Brown()      { return { 127u, 106u,  79u }; } // Brown
    static constexpr Color DarkBrown()  { return {  76u,  63u,  47u }; } // Dark Brown
                                        
    static constexpr Color White()      { return { 255u, 255u, 255u }; } // White
    static constexpr Color LightGray()  { return { 200u, 200u, 200u }; } // Light Gray
    static constexpr Color Gray()       { return { 130u, 130u, 130u }; } // Gray
    static constexpr Color DarkGray()   { return {  80u,  80u,  80u }; } // Dark Gray
    static constexpr Color Black()      { return {   0u,   0u,   0u }; } // Black
    static constexpr Color Blank()      { return {   0u,   0u,   0u, 0u }; } // Blank (Transparent)
    static constexpr Color Magenta()    { return { 255u,   0u, 255u }; } // Magenta
    static constexpr Color RayWhite()   { return { 245u, 245u, 245u }; } // My own White (raylib logo)

#ifdef HENRY_EXTRAS
    // Space gray
    static constexpr Color SpaceGray0() { return {  52u,  61u,  70u }; } // Dark space gray
    static constexpr Color SpaceGray1() { return {  79u,  91u, 102u }; } // Medium-dark space gray
    static constexpr Color SpaceGray2() { return { 101u, 115u, 126u }; } // Medium space gray
    static constexpr Color SpaceGray3() { return { 167u, 173u, 183u }; } // Medium-light space gray
    static constexpr Color SpaceGray4() { return { 192u, 197u, 206u }; } // Light space gray

    static constexpr Color R()          { return { 255u,   0u,   0u }; } // RGB red
    static constexpr Color G()          { return {   0u, 255u,   0u }; } // RGB green
    static constexpr Color B()          { return {   0u,   0u, 255u }; } // RGB blue
#endif
};
...
struct Rectangle
{
    ...
    constexpr Rectangle(float sideLength)
        : x(0), y(0), width(sideLength), height(sideLength) {}

    constexpr Rectangle(float width, float height)
...
#ifdef HENRY_EXTRAS
    constexpr float XMin() const { return x; }
    constexpr float XMax() const { return x + width; }
    constexpr float YMin() const { return y; }
    constexpr float YMax() const { return y + height; }
    ...
    constexpr Vector2 Extents()  const { return { width * 0.5f, height * 0.5f }; } // Half of the size
    ...
    void Move(Vector2 delta)     { x += delta.x; y += delta.y; }
    void SetPosition(Vector2 pt) { x = pt.x; y = pt.y; }
