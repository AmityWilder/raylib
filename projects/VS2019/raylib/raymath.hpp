...
// Threshold within which two floats are considered equal
...
// Clamp int value
RMAPI float Clamp(int value, int min, int max)
{
    int result = fminf(fmaxf(value, min), max);
...
RMAPI Vector2 operator+(Vector2 v1, Vector2 v2)
{
...
RMAPI Vector2 operator+(Vector2 v, float add)
{
...
RMAPI Vector2 operator-(Vector2 v, float sub)
{
...
RMAPI Vector2 operator*(Vector2 v, float scale)
{
...
// Add two vectors
RMAPI Vector3 operator+(Vector3 v1, Vector3 v2)
{
...
// Add vector and float value
RMAPI Vector3 operator+(Vector3 v, float add)
{
...
// Subtract vector by float value
RMAPI Vector3 operator-(Vector3 v, float sub)
{
...
RMAPI Vector3 operator*(Vector3 v, float scalar)
{
...
RMAPI Vector3 Min(Vector3 v, float f)
{
    Vector3 result = { 0 };

    result.x = fminf(v.x, f);
    result.y = fminf(v.y, f);
    result.z = fminf(v.z, f);

    return result;
}

RMAPI Vector3 Min(float f, Vector3 v)
{
    Vector3 result = { 0 };
...
RMAPI Vector3 Max(Vector3 v, float f)
{
    Vector3 result = { 0 };

    result.x = fmaxf(v.x, f);
    result.y = fmaxf(v.y, f);
    result.z = fmaxf(v.z, f);

    return result;
}

RMAPI Vector3 Max(float f, Vector3 v)
{
    Vector3 result = { 0 };
...
// Add two quaternions
RMAPI Quaternion operator+(Quaternion q1, Quaternion q2)
{
...
RMAPI Quaternion operator+(Quaternion q, float add)
{
